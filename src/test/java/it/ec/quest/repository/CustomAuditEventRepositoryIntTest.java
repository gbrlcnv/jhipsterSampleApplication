...
import it.ec.quest.config.audit.AuditEventConverter;
import it.ec.quest.domain.PersistentAuditEvent;
...
import static it.ec.quest.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
