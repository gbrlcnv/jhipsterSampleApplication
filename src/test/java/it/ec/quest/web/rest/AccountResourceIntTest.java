...
import it.ec.quest.config.Constants;
import it.ec.quest.JhipsterSampleApplicationApp;
import it.ec.quest.domain.Authority;
import it.ec.quest.domain.PersistentToken;
import it.ec.quest.domain.User;
import it.ec.quest.repository.AuthorityRepository;
import it.ec.quest.repository.PersistentTokenRepository;
import it.ec.quest.repository.UserRepository;
import it.ec.quest.security.AuthoritiesConstants;
import it.ec.quest.service.MailService;
import it.ec.quest.service.dto.UserDTO;
import it.ec.quest.web.rest.errors.ExceptionTranslator;
import it.ec.quest.web.rest.vm.KeyAndPasswordVM;
import it.ec.quest.web.rest.vm.ManagedUserVM;
import it.ec.quest.service.UserService;
