...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(it.ec.quest.domain.PersistentToken.class.getName(), jcacheConfiguration);
            cm.createCache(it.ec.quest.domain.User.class.getName() + ".persistentTokens", jcacheConfiguration);
